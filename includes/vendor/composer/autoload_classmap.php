...
return array(
    ...
    'PloverToc\\Enum' => $baseDir . '/src/Core/Enum.php',
    'PloverToc\\PluginManager' => $baseDir . '/src/Core/PluginManager.php',
    'PloverToc\\TableOfContents' => $baseDir . '/src/Core/TableOfContents.php',
